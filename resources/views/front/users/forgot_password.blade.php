                    ...
                    <div class="breadcrumb">
                        <div class="breadcrumb__wrap">
                            <ul class="breadcrumb__list">
                                ...
                                <li class="is-marked">
                                    <a href="{{ url('user/reset-password/') }}">Đặt lại mật khẩu</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="l-f-o__pad-box">
                                    ...
                                    <form class="l-f-o__form" id="forgotForm" action="javascript:;" method="post">
                                        ...
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--primary-style" name="email" type="text" id="reset-email" placeholder="Enter E-mail">
