        ...
        <div class="container">
            ...
            <div class="primary-nav">
                ...
                <a class="main-logo" href="{{ url('/') }}">
                    <img src="{{ asset('front/images/logo/logo_dt.png') }}" alt=""></a>
                <!--====== End - Main Logo ======-->
                <!--====== Search Form ======-->
...
{{--                            <li class="has-dropdown" data-tooltip="tooltip" data-placement="left" title="Language">--}}
...
{{--                            </li>--}}
                            <li class="has-dropdown">
                                <a class="mini-cart-shop-link" href="{{ url('/cart') }}" ><i class="fas fa-shopping-bag"></i>
