    ...
    <div class="product-m">
        <div class="product-m__thumb">
            ...
            <div class="product-m__add-cart">
                <a class="btn--e-brand" href="{{ url('product/'.$product['id']) }}" data-modal="modal" data-modal-id="#add-to-cart">Xem chi tiết</a></div>
        </div>
        <div class="product-m__content">
            <div class="product-m__category">
                <a href="#">{{ $product['brand']['brand_name'] }}</a></div>
...
{{--                <span class="product-m__review">(25)</span></div>--}}
            <div class="product-m__price">{{number_format($product['final_price'], 0, ',', '.')}}₫
