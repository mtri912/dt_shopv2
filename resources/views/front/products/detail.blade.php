                        ...
                        <div class="pd-detail">
                            ...
                            <div>
                                <div class="pd-detail__inline getAttributePrice">
                                    ...
                                    <span class="pd-detail__price">₫{{number_format($productDetails['final_price'], 0, ',', '.')}}</span>
                                    @if($productDetails['discount_type']!="")
{{--                                    <span class="pd-detail__discount">({{$productDetails['product_discount']}}% OFF)</span>--}}
                                        <del class="pd-detail__del">₫{{number_format($productDetails['product_price'], 0, ',', '.')  }}</del>
                                    @endif
                                </div>
                            </div>
...
{{--                                    <span class="pd-detail__stock">200 trong kho</span>--}}
                                        ...
                                        <div class="pd-detail__color">
                                            ...
                                            <a href="{{ url('product/'.$product['id']) }}">
                                                <div class="color__radio">
                                                    <label class="color__radio-label" for="folly" style="background-color: {{$product['product_color']}}">
                                                    </label>
                                                </div>
                                            </a>
                                            @endforeach
