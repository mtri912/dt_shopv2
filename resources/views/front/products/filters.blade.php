                            ...
                            @foreach($getPrices as $key => $price)
                                ...
                                <li>
                                    ...
                                    <div class="check-box">
                                        ...
                                        <div class="check-box__state check-box__state--primary">
                                            <label class="check-box__label" for="price{{$key}}">{{$formattedPrice}}</label>
                                        </div>
                                    </div>
                                    <!--====== End - Check Box ======-->
                                </li>
                        ...
                        @foreach($getColors as $key => $color)
                            ...
                            <li>
                                <div class="color__check">
                                    ...
                                    <label class="color__check-label" for="jet" style="background-color: {{$color}}" title="{{$color}}"></label>
                                </div>{{$color}}
                            </li>
                        @endforeach
                    </ul>
...
//            dd($getDynamicFilter);
        ?>
        @foreach($getDynamicFilter as $filter)
        <div class="u-s-m-b-30">
            <div class="shop-w shop-w--style">
                <div class="shop-w__intro-wrap">
                    ...
                    <ul class="shop-w__list gl-scroll">
                        ...
                        <li>
                            ...
                            <div class="check-box">
                                ...
                                <input type="checkbox" id="filter{{$fkey}}" name="{{$filter}}" value="{{$filterValue}}" class="filterAjax">
                                <div class="check-box__state check-box__state--primary">
