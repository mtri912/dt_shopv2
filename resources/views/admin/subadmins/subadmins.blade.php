                                    ...
                                    @foreach($subadmins as $subadmin)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a class="updateSubadminStatus" id="subadmin-{{ $subadmin->id }}" subadmin_id="{{ $subadmin->id }}" style="color: grey" href="javascript:void(0)">
                                                ...
                                                &nbsp;&nbsp;&nbsp;
                                                <a style="color: #3f6ed3" class="confirmDelete" title="Delete CMSPages" href="javascript:void(0)" record="subadmin" recordid="{{ $subadmin->id }}">
