...
class FiltersTableSeeder extends Seeder
{
    ...
    {
        $filterRecords = [
            ['id' => 1, 'filter_name' => 'Material', 'filter_value' => 'Cotton', 'sort' => 1, 'status' => 1],
            ['id' => 2, 'filter_name' => 'Material', 'filter_value' => 'Polyester', 'sort' => 2, 'status' => 1],
            ['id' => 3, 'filter_name' => 'Material', 'filter_value' => 'Wool', 'sort' => 3, 'status' => 1],
