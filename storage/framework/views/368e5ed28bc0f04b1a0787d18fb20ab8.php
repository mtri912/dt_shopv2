                        ...
                        <div class="breadcrumb__wrap">
                            <ul class="breadcrumb__list">
                                ...
                                <li class="is-marked">
                                    ...
                                    <a href="<?php echo e(url('/user/login')); ?>">Đăng nhập</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="l-f-o">
                                <div class="l-f-o__pad-box">
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <a class="l-f-o__create-link btn--e-transparent-brand-b-2" href="<?php echo e(url('user/register')); ?>">TẠO MỘT TÀI KHOẢN</a></div>
                                    ...
                                    <form class="l-f-o__form" id="loginForm" action="javascript:;" method="post">
                                        ...
                                        <div class="gl-inline">
                                            ...
                                            <div class="u-s-m-b-30">
                                                <a class="gl-link" href="<?php echo e(url('user/forgot-password')); ?>">Quên mật khẩu?</a></div>
                                        </div>
                                        <div class="u-s-m-b-30">
                                            ...
                                            <div class="check-box">
                                                ...
                                                <input type="checkbox" id="remember-me" name="remember-me" <?php if(isset($_COOKIE["user-email"])): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dt_shop-v2\resources\views/front/users/login.blade.php ENDPATH**/ ?>