                    ...
                    <div class="breadcrumb">
                        <div class="breadcrumb__wrap">
                            <ul class="breadcrumb__list">
                                ...
                                <li class="is-marked">
                                    <a href="<?php echo e(url('user/update-password')); ?>">Đổi mật khẩu</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dt_shop-v2\resources\views/front/users/update_password.blade.php ENDPATH**/ ?>