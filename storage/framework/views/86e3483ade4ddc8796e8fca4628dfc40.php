                        ...
                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: center;">
                            ...
                            <tr>
                                <td style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">Your Order has been Shipped with below Tracking Details:<br>
                                    <strong>Courier Name:</strong> <?php echo e($courier_name); ?> | <strong>Tracking Number:</strong> <?php echo e($tracking_number); ?>
                        ...
                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #bbbbbb;">
                            ...
                            <tr>
                                ...
                                <td style="width: 45%; font-size: 14px; line-height: 18px; color: #666666;">
                                    <?php echo e($orderDetails['user']['name']); ?>
                            ...
                            <tr>
                                ...
                                <td style="width: 45%; font-size: 14px; line-height: 18px; color: #666666;">
                                    <?php echo e($orderDetails['user']['address']); ?>
                            ...
                            <tr>
                                ...
                                <td style="width: 45%; font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 10px;">
                                    <?php echo e($orderDetails['user']['ward']['full_name']); ?>, <?php echo e($orderDetails['user']['district']['full_name']); ?>, <?php echo e($orderDetails['user']['province']['full_name']); ?>
                ...
                <tr>
                    <td style="padding-top: 30px;">
                        <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border-bottom: 1px solid #eeeeee; text-align: center;">
                            ...
                            <tr>
                                <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                    Download Order Invoice at <a href="<?php echo e(url('download-order-pdf-invoice/'.$order_id)); ?>"><?php echo e(url('download-order-pdf-invoice/'.$order_id)); ?></a><br>
                            ...
                            <tr>
                                <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                   For any queries, you can contact us at <a href="mailto:info@dtsneaker.in">info@dtsneaker.in</a>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-size: 14px; line-height: 18px; color: #666666;">
...
<?php /**PATH D:\xampp\htdocs\dt_shop-v2\resources\views/emails/shipped_order.blade.php ENDPATH**/ ?>